...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Puedes iniciar sesión usando tu correo electrónico y la contraseña:</p>
            <p>
                <strong>Correo electrónico:</strong> {{ $user->email }}<br>
                <strong>Contraseña:</strong> {{ $password }}
            </p>
            <a href="{{config('')}}" class="button" style="background-color:{{$config_global->primary_color}};">Inicia sesión</a><br><br>
