    ...
    <div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <div class="d-flex flex-wrap align-items-center gap-3">
                <a href="javascript:void(0)" onclick="confirmUpdate()" class="d-flex justify-content-center align-items-center" style="padding: 6px 10px !important;border-radius: 5px;background-color: green;color: white;">
                    <iconify-icon icon="material-symbols:update" class="icon"></iconify-icon>
                    Actualizar
                </a>
                <button type="button" data-theme-toggle class="w-40-px h-40-px bg-neutral-200 rounded-circle d-flex justify-content-center align-items-center"></button>
                <div class="dropdown d-none d-sm-inline-block" style="display: none!important;">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        ...
                        <div>
                            <h6 class="text-lg text-primary-light fw-semibold mb-0">Elige el idioma</h6>
                        </div>
                        </div>
                ...
                <div class="dropdown" style="display: none;">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-lg p-0">
                        ...
                        <div class="text-center py-12 px-16"> 
                            <a href="javascript:void(0)" class="text-primary-600 fw-semibold text-md">Todas las notificaciones</a>
                        </div>
                    </div>
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle" type="button" data-bs-toggle="dropdown">
                        <img src="{{asset('assets/images/favicon.png')}}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
                    </button>
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                        <div>
                            <h6 class="text-lg text-primary-light fw-semibold mb-2">{{Auth::user()->fullname}}</h6>
                        ...
                        <li style="display: none;">
                            ...
                            <iconify-icon icon="tabler:message-check" class="icon text-xl"></iconify-icon>Entrantes</a>
                        </li>
                        <li>
                            <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3" href="{{ route('config.edit','0195aa88-19d7-7045-9116-fb9f61b75e4c') }}"> 
                            <iconify-icon icon="icon-park-outline:setting-two" class="icon text-xl"></iconify-icon>Configuración</a>
                        </li>
                        <li>
