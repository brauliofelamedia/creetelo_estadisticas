        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <h5 class="mb-12">Iniciar sesión sin contraseña</h5>
                    <p class="mb-32 text-secondary-light text-lg">Ingresa tu correo y te enviaremos un enlace mágico para iniciar sesión</p>
                </div>
                @if(session('error'))
                ...
                @endif
                <form method="POST" action="{{ route('magic.generate.token') }}">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary fw-semibold text-md px-24 py-16 w-100 radius-12 mt-32 d-flex align-items-center justify-content-center gap-12">
                        <iconify-icon icon="mdi:magic" class="text-xl line-height-1"></iconify-icon>
